...
import { useDemonStatus } from "./services/storageAdapter";
...
export function CharSheet(props: CharSheetProps): JSX.Element {
  ...
  const demonStatusService = useDemonStatus();

  const { backgroundOptions, loreOptions } = useDropdownOptions();
  ...
  return (
    <>
      <CharSheetBody>
        ...
        <StatusSection className="tw-mb-3" {...demonStatusService} />
      </CharSheetBody>
