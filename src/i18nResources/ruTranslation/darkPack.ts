export const darkPack = {
  ...
  intro:
    "Сайт содержит листы персонажей и онлайн-инструменты по World of Darkness. Согласно Dark Pack для такого некоммерческого фанатского проекта требуется разместить логотип Dark Pack, уведомление об авторских правах и товарных знаках, а также явную пометку о неофициальном статусе материала.",
  ...
  compliancePoint2:
    "Точное legal notice из соглашения размещено в глобальном footer, доступном со всех основных страниц сайта.",
  compliancePoint3:
